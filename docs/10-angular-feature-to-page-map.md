...
| Component Inputs (`input()`) | Shared cards, badges, help | Reusable UI configured by parent pages; `FloatingHelpComponent` uses the signal-based `input()` API | `shared/components` |
